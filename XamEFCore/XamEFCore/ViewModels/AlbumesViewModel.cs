...
namespace XamEFCore.ViewModels
{
    public class AlbumesViewModel : BaseViewModel
    {
        ...
        private void CreateArtistas()
        {
            ...
            {
                new Artista { Nombre = "Porter Robinson" },
                new Artista { Nombre = "Lyn" },
                new Artista { Nombre = "Imagine Dragons" },
                new Artista { Nombre = "Pentakill" },
                new Artista { Nombre = "MFDoom" },
                new Artista { Nombre = "MoeShop" },
                new Artista { Nombre = "Tatsuro Yamashita" }
            };
